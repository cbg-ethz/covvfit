...
# %%
ba1ba2 = load_data("../workflows/evaluate_predictions/results/ba1ba2/")
with open("../workflows/evaluate_predictions/config_ba1ba2.yaml", "r") as file:
    ba1ba2_config = yaml.safe_load(file)

jn1 = load_data("../workflows/evaluate_predictions/results/jn1/")
with open("../workflows/evaluate_predictions/config_jn1.yaml", "r") as file:
...
fig, axes = plt.subplots(
    ...
    # sharex="col",
    sharey="row",
    gridspec_kw={"hspace": 0.75},  # Adjust vertical spacing
)
